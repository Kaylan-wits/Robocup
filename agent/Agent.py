...
class Agent(Base_Agent):
    ...
    # --- MODIFICATION START ---
    # Replaced the complex dribble/pass/alignment logic with a simple
    # call to kickTarget.
    def customDribbleAndShoot(self, strategyData):
        '''
        This function has been modified to ALWAYS kick towards the goal,
        replacing the previous dribbling and passing logic.
        '''
        ...
        # --- NEW LOGIC ---
        # Immediately execute a kick towards the target goal.
        # The Basic_Kick behavior (called by kickTarget) will automatically
        # handle aligning with the ball and then executing the kick.
